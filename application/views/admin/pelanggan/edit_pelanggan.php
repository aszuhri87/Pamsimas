<div id="layoutSidenav_content">
            ...
            <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-white"><i class="fa fa-files-o"></i> Form Ubah Data Pelanggan</h3>
                        <ol class="breadcrumb">
                            <li><i class="fa fa-home"></i><a href="beranda"> Home</a></li>
                            <li><i class="icon_document_alt"></i><a href="data_pelanggan.php">Data Pelanggan</a></li>
                            <li><i class="fa fa-files-o"></i>Form Ubah Data Pelanggan</a></li>
                        </ol>
                    </div>
                </div>
                <!-- Form validations -->
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-validate form-horizontal" id="feedback_form" method="post" action="<?php echo base_url(). 'admin/update_pelanggan'; ?>">
