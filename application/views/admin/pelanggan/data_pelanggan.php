<div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container mt-n10">
                        ...
                        <div class="row">
                    <div class="col-lg-12">
                        <h3 class="page-header text-white"><i class="fa fa-table"></i> Data Pelanggan</h3>
                        <ul class="breadcrumb" >
                            <li><i class="fa fa-home" ></i><a href="beranda"> &nbsp;Home</a></li> &ensp;
                            <li><i class="fa fa-th-list"></i><a href="data_pelanggan.php"> &nbsp;Data Pelanggan</a></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-advance table-hover table-responsive">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a class="btn btn-success" href="<?php echo site_url('admin/edit_pelanggan/'.$row->NIK) ?>"><i data-feather="edit"></i></a>
